...
const projects = [
...

  {
    ...
    web_stack:
      "I used vanilla CSS for the UI as I wanted to be comfortable with it. JavaScript to handle dropdown interactions. Axios for fetching data from the RestCountries API. Webpack for bundling as it was the bundler I wanted to learn.",
    lessons:
