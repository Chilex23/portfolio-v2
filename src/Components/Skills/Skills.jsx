...
const Skills = () => (
  <section className="mx-20 mt-32">
    ...
    <p className="my-6 text-lg max-w-[70%] leading-loose">
      ...
      by self-studying, and I have dedicated a lot of my free time to apply these
    ...
    <div className="flex mt-8 flex-wrap max-w-[70%] gap-5">
