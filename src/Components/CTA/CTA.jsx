...
const CTA = () => (
  <>
    <div
      className={`relative z-10 mt-7 mx-5 sm:mx-20 text-4xl tablet:text-5xl font-semibold leading-tight md:flex gap-5 tablet:gap-28 before:content-['\\201C'] before:absolute before:text-[30rem] before:-left-[2rem] before:-top-[6rem] before:dark:text-gray-600 before:text-gray-300 before:-z-20`}
    >
      <motion.div
      ...
      <motion.figure
        initial={{ x: 2000 }}
        animate={{ x: 0 }}
        transition={{ duration: 0.8, ease: [0.31, 0.1, 0.66, 0.66], delay: 0.6 }}
